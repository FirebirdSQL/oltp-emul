...
7. Each client order and each invoice to supplier can be paid for 100% or less, and this must be reflected in customer or supplire balance (separately). Each paiment operation can be cancelled.
8. After test finish first of running session invokes reports about performance (total and detailed), list of occured exceptions, database statistics, result of DB validation et al.
