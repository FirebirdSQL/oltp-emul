...
# must be the same as 'HQnn_LOCK_DIR' parameter for appropriate 'head' major version
# of HQbird defined in oltp-scheduled_config.nix:
HQ_HEAD_LOCK_DIR=/dev/shm/hq50_lock
...
#
LOGDIR=/var/tmp/oltp_overall_report_hq
