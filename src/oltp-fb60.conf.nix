...
#::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   #
   # Examples:
   # dbnm = /var/db/oltp_60.fdb
   # dbnm = $TMP/data/oltp_60.fdb
   #
   # WARNING. DO NOT use names with spaces, parenthesis or non-ascii characters.
   #
   dbnm = /var/db/oltp-emul/oltp-fb60.fdb
   ...
   # - where <@.@> marks major FB version (2.5; 3.0 etc).
   #
   port = 3600
   ...
   # Examples:
   #     tmpdir = /var/tmp/logs.oltp60
   #     tmpdir = $TMP/logs.oltp60
   #
   # WARNING. DO NOT use names with spaces, parenthesis or non-ascii characters.
   #
   tmpdir = /var/tmp/logs.oltp-fb60
...
#::::::::::::::::::::::::::::::::::::
   ...
   # By default, UDF usage is deprecated in Firebird 4.0+ and parameter UDFacces is absent in firebird.conf.
   # You have to add it manually.
   #
   # TEMPORARY CHANGED 18.09.2025 00:22. WAS: 2
   mon_unit_perf = 2
   ...
   # This setting can be used only when config parameter 'mon_unit_perf' is 1.
   ...
   # This setting is applied only when config parameter 'mon_unit_perf' is 2.
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   results_storage_fbk = /opt/oltp-emul/data/oltp-fb60-results.fbk
   ...
   #
   etalon_dbnm = $(dirname "$dbnm")/oltp_60.etalone.fdb
   ...
   html_chart_color_perf_score = red
   html_chart_color_memo_all = red
   html_chart_color_memo_att = red
   html_chart_color_memo_trn = red
   html_chart_color_memo_stm = red
   ...
   #     YYYYmmDD_HHMM_score_07383_build__599_ss60__3h00m_100_att_fw__on_cpu4_ram32.txt
   # Example of report name when this parameter is 'benchmark':
   #     ss60_fw_off_split_most__sel_1st_one_index_score_07182_build__599__3h00m_100_att_YYYYmmDD_HHMM_cpu4_ram32.txt
   #     (where 'YYYYmmDD_HHMM' is timestamp when test started)
   #
