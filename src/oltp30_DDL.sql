...
-- NB: do NOT use here features of FB 3.0! This table is dropped and created again in oltp_adjust.dll - common script for 2.5 and 3.0
        ...
        begin
            ...
            begin
                ...
                select
                   ...
                   ,fn_this_worker_seq_no() as worker_id
                   ,:v_dts
...
begin
    ...
    for
        ...
        from doc_data d
        cross join v_rules_for_qdistr r
...
when any do
    begin
        ...
        --#######
        exception;  -- ::: nb ::: anon  imous but in when-block!
        --#######
    end
...
---------------------------------------------------------------------------
-- needed only in 3.0+, SP sys_get_func_ddl
