...
#::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   # WARNING. DO NOT use names with spaces, parenthesis or non-ascii characters.
   #
   dbnm = /var/db/oltp-emul/oltp-hq50.fdb
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   results_storage_fbk = /opt/oltp-emul/data/oltp-hq50-results.fbk
   ...
   html_chart_color_perf_score = blue
   html_chart_color_memo_all = blue
   html_chart_color_memo_att = blue
   html_chart_color_memo_trn = blue
   html_chart_color_memo_stm = blue
   ...
   #     YYYYmmDD_HHMM_score_07011_build_2241_ss50__3h00m_100_att_fw__on_cpu4_ram32.txt
   # Example of report name when this parameter is 'benchmark':
   #     ss50_fw_off_split_most__sel_1st_one_index_score_07989_build_2241__3h00m_100_att_YYYYmmDD_HHMM_cpu4_ram32.txt
