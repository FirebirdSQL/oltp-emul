...
# Second and third columns will have selectivity about 1/8.
# When choice = 'least_selective_first' then first and second columns will have poor selectivity = 1/8,
