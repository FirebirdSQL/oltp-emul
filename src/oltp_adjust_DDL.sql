...
select 1 as id, 1 as minute_since_test_start, 1 as success_count, 1 as worker_id, 1 as att_id, current_timestamp as dts 
from rdb$database;
commit;
...
create or alter view v_perf_estimated as 
-- Finally recreated in oltp_adjust_DDL.sql before every new test launch.
