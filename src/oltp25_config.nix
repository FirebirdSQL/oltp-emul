...
#::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   #     dpkg -L firebird2.5-classic or dpkg -L firebird2.5-superclassic
   #
   # clu = isql-fb
   ...
   #
   # Examples:
   # dbnm = /var/db/oltp_25.fdb
   # dbnm = $TMP/data/oltp_25.fdb
   #
   # WARNING. DO NOT use names with spaces, parenthesis or non-ascii characters.
   #
   dbnm = /var/db/oltp_25.fdb
...
#:::::::::::::::::::::::::::::::::::::::::::::::::::::
   ...
   #
   # Examples:
   # results_storage_fbk = $(dirname "$dbnm")/oltp_25_results.fbk
   # results_storage_fbk = /var/db/oltp_25-results-storage.fbk
   #
   ...
   #
   etalon_dbnm = $(dirname "$dbnm")/oltp_25.etalone.fdb
   ...
   #     YYYYmmDD_HHMM_score_00957_build_27152_sc25__3h00m_100_att_fw__on_cpu4_ram32.txt
   # Example of report name when this parameter is 'benchmark':
   #     sc25_fw_off_split_most__sel_1st_one_index_score_02545_build_27152__3h00m_100_att_YYYYmmDD_HHMM_cpu4_ram32.txt
